      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-base-100 max-md:px-8 max-w-3xl">
          ...
          <h2 className="font-extrabold text-3xl lg:text-5xl tracking-tight mb-8">
            {/* TODO: Remind visitors about the value of your product. Why do they need it? */}
            Supercharge your app instantly, launch faster, make $
          </h2>
          <div className="text-base-content/80 leading-relaxed mb-8 lg:text-lg">
            {/* TODO: Explain how your product delivers what you promise in the headline. */}
            Login users, process payments and send emails at lightspeed. Spend
            your time building your startup, not integrating APIs. This boilerplate
            provides you with everything you need to launch, FAST.
          </div>
        </div>
      </div>
