...
// TODO: Replace with real testimonials from your customers
const list: {
  username?: string;
  name: string;
  text: string;
...
}[] = [
  {
    username: "customer1",
    name: "John Doe",
    text: "This product is amazing! It's exactly what I needed to streamline my workflow and save time.",
    type: refTypes.twitter,
  },
  {
    username: "customer2",
    name: "Jane Smith",
    text: "Setting up everything from the ground up is really hard and time consuming. This solution saved me countless hours.",
    type: refTypes.twitter,
  },
  {
    username: "customer3",
    name: "Alex Johnson",
    text: "Easily saves 15+ hours per week. Now I can focus on shipping features rather than setting up the same technologies from scratch. Feels like a super power!",
    type: refTypes.productHunt,
  },
  {
    name: "Sarah Williams",
    text: "Just purchased and set up — I really love what I'm seeing here!",
    type: refTypes.other,
  },
  {
    username: "customer5",
    name: "Michael Brown",
    text: "Finally a good solution that doesn't require hours of configuration. Highly recommended!",
    type: refTypes.productHunt,
  },
  {
    username: "customer6",
    name: "Emily Davis",
    text: "It's a game changer 🚀 Easy to follow documentation, and saves you a ton of time. What's not to love?",
    type: refTypes.twitter,
  },
  {
    name: "Chris Wilson",
    text: "This tool saves me 10 hours on each project. Absolutely fantastic!",
    type: refTypes.other,
  },
  {
    name: "Customer",
    ...
    type: refTypes.other,
    // Uncomment below for video testimonial
  ...
  },
  {
    username: "customer9",
    name: "David Lee",
    text: "It's an amazing solution with well-organized code. It has almost all the core features you would want. As a team it actually took us months to build a similar set of features at a stable level.",
    type: refTypes.twitter,
  },
  {
    username: "customer10",
    name: "Lisa Anderson",
    text: "Probably one of the most powerful tools I've used that I've seen",
    type: refTypes.productHunt,
  },
  // The last testimonial is featured on big devices (span 2 columns + big font) 👇
  {
    username: "customer11",
    name: "Robert Taylor",
    text: "Having everything set up from the start is a blessing. This will save me like a week of work for each new project I spin up. I appreciate that it's well documented, as well. 100% worth it 🚀🚀🚀",
    type: refTypes.twitter,
  },
];
