...
// TODO: Update these features to match your product
const features = [
  {
    title: "Collect user feedback",
    description:
      "Use your feedback board to let users submit features they want.",
  ...
  },
  {
    ...
    demo: (
      <div className="px-6 max-w-[600px] flex flex-col gap-4 overflow-hidden">
        {[
          {
            text: "Add new payment integration to the platform",
  ...
  },
  {
    ...
    description: "Customize your feedback board with 7 themes.",
    ...
    demo: (
      <div className="text-neutral-content px-6 space-y-4">
        {[
          {
            id: 1,
            text: "Can we have a feature to add custom domains?",
            userImg: "",
            userName: "John D.",
            ...
            <div className="text-neutral/80 flex items-center gap-2 text-sm">
              <div className="flex items-center gap-2">
                <div className="avatar">
                  <div className="w-7 rounded-full bg-base-300 flex items-center justify-center">
                    {reply.userImg ? (
                      <img src={reply.userImg} alt={reply.userName} />
                    ) : (
                      <span className="text-xs font-medium">{reply.userName.charAt(0)}</span>
                    )}
                  </div>
                </div>
    ...
    <section className="flex justify-center items-center w-full bg-base-200/50 text-base-content py-20 lg:py-32">
      <div className="flex flex-col max-w-[82rem] gap-16 md:gap-20 px-4">
        <h2 className="max-w-3xl font-black text-4xl md:text-6xl tracking-[-0.01em]">
          {/* TODO: Update with your headline */}
